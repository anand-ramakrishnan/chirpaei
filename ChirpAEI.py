...
def chirpaei_main(path):
    ...
    SOUND_DIR = '/Users/INFERENCE/AcadianFlycatcher/input.mp3'
    INFERENCE_PATH = '/Users/INFERENCE/AcadianFlycatcher/'
    ...
    model = keras.models.load_model('/Users/MODELS/chirp_aei_model_35_class_0.7918')
